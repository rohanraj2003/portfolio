...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Rohan Raj",
    description: `Full-stack developer specializing in Python, Django & Web Security.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Rohan Raj" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Rohan Raj" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-xl font-bold tracking-tight">
            ROHAN RAJ SR<span className="text-primary">.</span>
          </span>
        </Link>
        ...
        <MagneticButton strength={0.45}>
          <a
            href="#contact"
            onClick={handleClick}
            className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-primary/40 bg-primary/10 px-4 py-1.5 text-sm font-medium text-primary transition hover:bg-primary/20"
          >
            Hire me
          </a>
        </MagneticButton>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Rohan Raj. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
      ...
      {/* Delayed UI — hidden during preloader */}
      <div
        style={{
